...
<body>
  <div class="overlay" role="main">
    <section class="card" aria-labelledby="login-title">
      ...
      <h1 id="login-title" class="title">Acceso Administrativo<br><small style="font-weight:500">Panel de administración.</small></h1>
      ...
      <form id="loginForm" method="post">
        ...
        <button class="btn" type="submit">Iniciar Sesión como Admin</button>
      </form>

      <div style="text-align:center;color:var(--muted);margin-top:8px;font-size:13px">Credenciales de prueba: admin / admin123</div>

      <div style="margin-top: 20px; text-align: center;">
        <a href="login.php" class="btn btn-secondary">Volver al Login Normal</a>
      </div>
